 ...
 *  网络请求子项
 */
@interface KYAsiNetworkItem : NSObject
/**
 *  网络请求方式
 */
@property (nonatomic, assign) KYAsiNetWorkType networkType;
 ...
 *  网络请求的委托
 */
@property (nonatomic, assign) id<KYAsiNetworkDelegate>delegate;
/**
 *   target
 */
 ...
 */
- (KYAsiNetworkItem *)initWithtype:(KYAsiNetWorkType)networkType
                               url:(NSString *)url
