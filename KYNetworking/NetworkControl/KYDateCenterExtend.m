...
#import "KYDateCenterExtend.h"
#import "NSObjectAdditions.h"
#import "NSStringExtend.h"
static KYDateCenterExtend*_shardManager;

@implementation KYDateCenterExtend
+ (KYDateCenterExtend *)sharedDataCenterExtend{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _shardManager = [[KYDateCenterExtend alloc]init];
    });
