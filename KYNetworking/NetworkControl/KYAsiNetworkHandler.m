...
#import "KYNetwork.h"
@interface KYAsiNetworkHandler ()
<KYAsiNetworkDelegate>
@end;
@implementation KYAsiNetworkHandler

+ (KYAsiNetworkHandler *)sharedInstance
{
    static KYAsiNetworkHandler *handler = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        handler = [[KYAsiNetworkHandler alloc] init];
    });
    ...
    [mgr setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        ...
        switch (status) {
            ...
            case AFNetworkReachabilityStatusNotReachable: // 没有网络(断网)
                [KYAsiNetworkHandler sharedInstance].networkError = YES;
                break;
...
{
    KYAsiNetworkHandler *handler = [KYAsiNetworkHandler sharedInstance];
